...
$authurl = "https://login.microsoftonline.com/atomicax.com/oauth2/v2.0/token"       
$clientId = 'f423fce0-5987-44d4-bb86-176fbd0c5ca9'
$username = 'testasdf@atomicax.com'
$password = 'Coldsteel_55!!'
$LcsApiUri = "https://lcsapi.lcs.dynamics.com"
$ProjectId = '1764459'
$SourceEnvironmentId = '298caad2-f897-4d82-80e2-91bffa21e381'
